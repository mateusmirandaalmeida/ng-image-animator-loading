...
class Animator {
  ...
  link(scope, element, attrs) {
    const imageURL = attrs.animatorLoading;
    const elm      = element && element[0] ? element[0] : undefined;
    this.clearElement(elm);  
...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__animator__ = __webpack_require__(1);


((exports, angular) => {

  if(!angular){
    throw "AngularJS not found in window!!";
  }
